...
def save_found():
    file1 = open("C:\\Users\\sahil\\Documents\\clg\\Python\\Saved\\" + search_place.get() + ".txt", "w")
...
def down_found_load():
    ...
    speech.save("C:\\Users\\sahil\\Documents\\clg\\Python\\Saved\\" + search_place.get() + ".mp3")
...
def play_found_sound():
    ...
    mixer.music.load("C:\\Users\\sahil\\Documents\\clg\\Python\\Saved\\" + str(search_place.get()) + ".mp3")
    mixer.music.play(0)
